box(title = "Simulation", width = 12, solidHeader = T, status = "primary",
    fluidRow(
      
      column(6, p(HTML("<b>Activate</b>"),
      ...
      column(6, p(HTML("<b>Left limit</b>"),
